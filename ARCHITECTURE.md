...
*   **Nova Estrutura Global (5 Camadas):** O layout atual será reestruturado para suportar a complexidade das Novas Eras e o motor procedural, dividindo o DOM em:
    ...
    3.  **Painel Lateral Dinâmico:** Contextual à seleção. Ao clicar em um Hexágono, em vez de dados globais, passará a extrair do ECS o Bioma, o Clima e a produção isolada daquele território exato.
        *   **Censo Local:** O painel deverá detalhar a demografia exata da região selecionada (Trabalhadores, Militares, Nobreza, População Total), extraindo os dados diretamente do ECS e dos multiplicadores da Sociedade.
...
*   **Mecânicas Visuais Planejadas (Qualidade de Vida):**
    *   **Progressão Visual de UI (Eras):** A interface gráfica não deve oprimir o jogador iniciante. Na Era 1 (Aurora), apenas recursos essenciais como "População", "Comida" e "Madeira" devem ser exibidos. Conforme novas tecnologias são descobertas, a interface revela organicamente as labels de Ouro, Fé, e abas complexas de Governo, garantindo que o visual do jogo evolua com o conhecimento da civilização.
